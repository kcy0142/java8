...
public class dateTest3 {
	...
	public static void main(String[] args) {
		  ...
		  System.out.println("==========yesterDay:"+yesterDay); //==========yesterDay:2017-09-20
		  System.out.println("==========yesterDay LocalTime.MIN :"+LocalDateTime.of(yesterDay, LocalTime.MIN)); //==========yesterDay LocalTime.MIN :2017-09-20T00:00
		  System.out.println("==========yesterDay  LocalTime.MAX:"+LocalDateTime.of(yesterDay, LocalTime.MAX)); //==========yesterDay  LocalTime.MAX:2017-09-20T23:59:59.999999999
		  System.out.println("==========yesterDay  LocalTime.NOON:"+LocalDateTime.of(yesterDay, LocalTime.NOON));//==========yesterDay  LocalTime.NOON:2017-09-20T12:00
		  System.out.println("==========date LocalTime.MIDNIGHT:"+LocalDateTime.of(yesterDay, LocalTime.MIDNIGHT)); //	==========date LocalTime.MIDNIGHT:2017-09-20T00:00
		  
		  System.out.println("==================기간 가져오기=======================");
